        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center min-h-[70vh]">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9 }}>
            ...
            <div className="overflow-hidden">
              {['QUALITY', 'BUILDING', 'MATERIALS.'].map((line, i) => (
                <motion.div key={line} initial={{ y: '110%' }} animate={{ y: 0 }} transition={{ duration: 1, delay: 0.5 + i * 0.15, ease: [0.16, 1, 0.3, 1] }}>
                  <h1 className={`font-heading leading-[0.92] tracking-tight ${line === 'BUILDING' ? 'text-orange-600 italic font-bold' : 'text-gray-900 font-light'}`}
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.2 }} className="flex flex-wrap gap-4 mt-10">
              ...
              <a href={`tel:${business.phoneRaw}`} className="group inline-flex items-center gap-3 border border-gray-300 text-gray-700 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold hover:border-orange-500 hover:text-orange-600 transition-all" style={{ fontFamily: 'var(--font-sans)' }}>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.4 }} className="flex items-center gap-6 mt-10 pt-8 border-t border-gray-200">
              {[{ n: business.projectsCompleted, l: 'Customers' }, { n: business.yearsExperience, l: 'Years' }, { n: business.rating + '★', l: 'Rating' }].map((s, i) => (
                <div key={i}>
                  <div className="text-orange-600 font-heading text-xl sm:text-2xl italic leading-none">{s.n}</div>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9, delay: 0.2 }} className="relative">
            ...
            <div className="absolute -bottom-4 -left-4 bg-orange-600 text-white p-6 shadow-xl z-10">
              <div className="text-center">
                <div className="font-heading text-3xl italic leading-none">{business.established}</div>
                <div className="text-orange-200 text-[9px] uppercase tracking-[0.2em] mt-1" style={{ fontFamily: 'var(--font-sans)' }}>Established</div>
              </div>
            </div>
            <div className="absolute -top-3 -right-3 w-20 h-20 border-t-2 border-r-2 border-orange-400/40" />
          </motion.div>
        </div>
      </div>
    </section>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9 }}>
            ...
            <h2 className="font-heading text-gray-900 leading-[0.95] italic mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              The PG<br /><span className="text-orange-500">Story</span>
            </h2>
            {about.story.map((p, i) => (
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}}
            ...
            <h2 className="font-heading text-gray-900 leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-orange-500">PG</span>
            </h2>
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={siteData.hero.backgroundImages[0]?.url} alt="PG Centre Mega Mall" className="w-full h-[130%] object-cover object-center" loading="lazy" />
